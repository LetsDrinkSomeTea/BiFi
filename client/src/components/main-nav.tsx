...
import {InfoSheet} from "@/components/info-sheet.tsx";
      ...
      <>
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 text-muted-foreground">
            {/* Info Sheet Trigger */}
            <InfoSheet isOpen={isInfoSheetOpen} setIsOpen={setIsInfoSheetOpen} user={user}/>
            ...
            <Sheet>
              ...
              <SheetContent side="right">
                ...
                <div className="flex flex-col gap-4 py-4">
                  {navigation.map(item =>
                          item.show && (
                              <Link key={item.href} href={item.href}>
                                <Button
                                    variant={item.href === currentPath ? "secondary" : "ghost"}
                                    className="w-full justify-start hover:text-muted-foreground"
                                >
                  ...
                  {user?.isAdmin && (
                      <SheetDescription className="text-muted-foreground">Admin</SheetDescription>
                  )}
